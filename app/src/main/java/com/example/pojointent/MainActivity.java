    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Rabbani Sidiq Fauzi Muhammad");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 16);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mperson = new Person();
                mperson.setName("Rabbani Sidiq Fauzi Muhammad");
                mperson.setAge(16);
                mperson.setEmail("rabbanisidiq@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "0895352288733";
